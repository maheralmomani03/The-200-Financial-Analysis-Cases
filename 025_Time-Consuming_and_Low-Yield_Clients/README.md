...
2. **Profitability per Hour Audit:** Calculate the net profit divided by actual hours worked for every client monthly.
3. **The "Fire" Threshold:** Set a minimum acceptable EHR; if a client falls below it for two consecutive quarters, renegotiate or terminate the contract.
